...
const blogPostsData: BlogPost[] = [
  {
    ...
    excerpt: "My journey from sales professional to software engineer, including the challenges, learnings, and key strategies that made the transition successful. This post covers the mindset shifts, technical skills acquisition, and networking strategies that helped me make this career pivot.",
    content: `
...
The combination of business acumen and technical skills makes you a valuable asset to any development team.
  ...
  },
  {
    ...
    excerpt: "How the mental discipline, strategic thinking, and performance optimization skills from professional sports translate directly to software development. Exploring the parallels between athletic performance and coding excellence.",
    content: `
...
Professional sports taught me that excellence is a habit, not an accident—a principle that guides my approach to software engineering every day.
  ...
  },
  {
    ...
    excerpt: "Insights into platform development at ServiceNow, including best practices, common challenges, and the unique aspects of enterprise software development. A deep dive into what makes platform engineering different from traditional software development.",
    content: `
...
export const blogPosts: BlogPostWithReadTime[] = blogPostsData.map(post => ({
  ...post,
